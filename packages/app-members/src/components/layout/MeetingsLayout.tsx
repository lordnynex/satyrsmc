      ...
      >
        ...
        <nav className="space-y-6 py-4" aria-label="Meetings section">
          <div className="space-y-0.5">
            ...
            <NavLink
              to="/admin/meetings/old-business"
              className={({ isActive }) => navLinkClass({ isActive }, collapsed)}
            ...
            <NavLink
              to="/admin/meetings/roberts-rules"
              className={({ isActive }) => navLinkClass({ isActive }, collapsed)}
