        ...
        <nav className="space-y-6 py-4" aria-label="Contacts section">
            ...
            {collapsed ? (
              ...
              <>
                <div className="mb-2 flex items-center justify-between px-3">
                  ...
                  <button
                    type="button"
                    onClick={() => navigate("/admin/contacts/lists?create=1")}
                  ...
                  <div className="mb-3">
                    ...
                    <ul className="space-y-0.5">
                      {physicalLists.map((list) => (
                        <li key={list.id}>
                          <NavLink
                            to={`/admin/contacts/lists/${list.id}`}
          ...
          <div>
            ...
            <div className={cn("space-y-0.5", collapsed && "space-y-1")}>
              <NavLink
                to="/admin/contacts/compose/mailing"
              ...
              <NavLink
                to="/admin/contacts/compose/email"
                className={({ isActive }) => listLinkClass({ isActive })}
              ...
              <NavLink
                to="/admin/contacts/compose/assets"
                className={({ isActive }) => listLinkClass({ isActive })}
                  ...
                  <div>
                    <div className="mb-2 flex items-center justify-between px-3">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          navigate("/admin/contacts/lists?create=1");
