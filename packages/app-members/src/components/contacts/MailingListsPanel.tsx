    ...
    return (
      <Suspense fallback={<PageLoading />}>
        <MailingListDetail
          listId={listId}
          events={events}
          onBack={() => navigate("/admin/contacts/lists")}
        />
      </Suspense>
    );
  }
            ...
            <div className="space-y-2">
              {lists.map((l) => (
                <div
                  ...
                  onClick={() => navigate(`/admin/contacts/lists/${l.id}`)}
                >
                  <div>
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/admin/contacts/lists/${l.id}`);
                    }}
                  >
                    Open
                  </Button>
              ...
              {includedPage.contacts.length === 0 ? (
                ...
                <>
                  <ContactDirectoryTable
                    ...
                    onRowClick={(c) => navigate(`/admin/contacts/${c.id}`)}
