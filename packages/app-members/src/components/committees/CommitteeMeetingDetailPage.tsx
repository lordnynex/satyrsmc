...
export function CommitteeMeetingDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate(`/admin/meetings/committees/${committeeId}`);
    } finally {
      setDeleting(false);
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" asChild>
              <Link to={`/admin/meetings/committees/${committeeId}`}>
          ...
          <div className="flex w-full items-center justify-between gap-2 rounded-t-lg px-3 py-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Button variant="ghost" size="sm" className="h-7 px-2" asChild>
                <Link
                  to={`/admin/meetings/committees/${committeeId}/meetings/${meetingId}/agenda/edit`}
                >
            ...
            <div className="flex items-center gap-1.5">
              {meeting.minutes_document_id && (
                <>
                  ...
                  <Button variant="ghost" size="sm" className="h-7 px-2" asChild>
                    <Link
                      to={`/admin/meetings/committees/${committeeId}/meetings/${meetingId}/minutes/edit`}
                    >
                      <Pencil className="size-3.5" />
                      Edit
                    </Link>
