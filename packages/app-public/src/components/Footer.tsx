...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-auto border-t border-slate-700/60 bg-slate-900/60">
      <div className="container py-6 flex flex-col gap-2 items-center text-center">
        <Logo />
        ...
        <small className="opacity-70">
          © {new Date().getFullYear()} Satyrs Motorcycle Club of Los Angeles. All Rights Reserved.
        </small>
      </div>
    </footer>
  );
